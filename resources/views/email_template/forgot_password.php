...
<!--                                                  <td style="padding: 0 0 10px 0;border-bottom: 1px solid #cecece;">
                              ...
                              <tr>
                                   <td align="center" valign="top" style="">
                                        <table border="0" cellpadding="20" cellspacing="0"  style="width:100%;padding-bottom:0px;">
                                             <tr>
                                                  <td style="padding: 0 0 20px 0;font-family: 'Lato', sans-serif;font-size: 20px;text-align:center;color:#334150;font-weight: 800;">Hi, <?= $full_name?>!</td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                  <td style="padding: 0 0 20px 0;">
                                                       <a href="<?= $link ?>" style="background-color: #249AF3;color:#fff;padding:10px 50px;font-size: 13px;font-family: 'Lato', sans-serif;font-weight:400;width: 120px;display: block;margin:0 auto;border-radius:5px;">Reset You Password</a>
                                                  </td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                  <td style="padding: 20px 0 5px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">Please send any feedback or bug reports <br/>
                                                       to <a href="mailto:hello@construction.com" style="color:#249AF3;">hello@accountability.com</a>
                                                  </td>
                                             </tr>
                              ...
                              <tr>
                                   <td style="padding: 0 0 20px 0;text-align:center;color:#7F8FA4;font-family: 'Lato', sans-serif;font-size: 16px;font-weight:400;">
                                        ⓒ Accountability Lodger Inc. - 702 Rath Parks, New-York, USA
                                   </td>
