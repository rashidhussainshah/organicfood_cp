                ...
                <div class="box">
                    ...
                    <div class="col-md-12">
                        <input type="button" class="btn btn-primary pull-right identity" data-toggle="modal"
                               data-target="#add-tag-modal" value="Add Tag">
                    </div>
                    <div class="box-body">
                        <table id="full_feature_datatable" class="table table-bordered table-striped">
                            ...
                            @foreach ($tags as $data)
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ asset('admin/delete_tag/'.$data->id)}}"
                                ...
                                <div class="modal fade view_details" id="edit-modal{{ $data->id }}">
                                    <form class="update_cat{{$data->id}}" action="{{ route('tag.update')}}"
                                          method="Post">
                                        {{ csrf_field() }}
                                        <div class="modal-dialog">
...
{{--                            {{ $attributes->render() }}--}}
    ...
    <div class="modal fade" id="add-tag-modal">
        <form id="add_attribute" action="{{ route('tag.store') }}" method="post">
            {{ csrf_field() }}
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
