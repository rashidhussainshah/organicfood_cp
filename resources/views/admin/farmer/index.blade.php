        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="col-md-12">
                        <a href="{{route('farmer.create')}}" type="button" class="btn btn-primary pull-right identity">Add Farmer</a>
...
{{--                                        --}}
                                        <a href="{{route('farmer.edit', ['user'=>$data->id])}}"  class="text-primary"><i
                                                class="fa fa-pencil-square-o"></i></a>
                                    </td>
                                </tr>
