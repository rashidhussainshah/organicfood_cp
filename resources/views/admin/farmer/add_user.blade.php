            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Farmer</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" id="exampleInputEmail1" placeholder="Name" required autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{old('email')}}"  autocomplete="email" id="exampleInputPassword1" placeholder="Email"required>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
