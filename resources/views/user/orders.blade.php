    ...
    <div class="col-12 row m-0 order-list">
            ...
            <div class="row col-12">
                ...
                <div class="btn-group dropDate col-md-4 mt-md-0 mb-md-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" id="dropCal">
                        <button class="dropdown-item" onclick="window.location.href = '{{asset('user/calendar/30')}}'"> Last 30 Days</button>
                        <button class="dropdown-item"  onclick="window.location.href = '{{asset('user/calendar/20')}}'"> Last 20 Days</button>
                        <button class="dropdown-item"  onclick="window.location.href = '{{asset('user/calendar/10')}}'"> Last 10 Days</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-100 mb-5 tabs-area order-tab add mt-4">
            <nav class="nav nav-tabs w-100" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-allOrders-tab" data-toggle="tab" href="#nav-allOrders" role="tab" aria-controls="nav-allOrders" aria-selected="true"> All <span>({{$orders_count->get_farm_count}})</span></a>
                <a class="nav-item nav-link" id="nav-trashed-tab" data-toggle="tab" href="#nav-trashed" role="tab" aria-controls="nav-trashed" aria-selected="false">Trash <span>({{$trashed_orders_count->get_farm_count}})</span></a>
                <a class="nav-item nav-link" id="nav-prsng-tab" data-toggle="tab" href="#nav-prsng" role="tab" aria-controls="nav-prsng" aria-selected="false">Processing ({{$processing_orders_count->get_farm_count}})</a>
                <a class="nav-item nav-link" id="nav-hold-tab" data-toggle="tab" href="#nav-hold" role="tab" aria-controls="nav-hold" aria-selected="false">On Hold ({{$onhold_orders_count->get_farm_count}})</a>
                <a class="nav-item nav-link" id="nav-cancelled-tab" data-toggle="tab" href="#nav-cancelled" role="tab" aria-controls="nav-cancelled" aria-selected="false">Cancelled ({{$cancelled_orders_count->get_farm_count}})</a>
            </nav>
            <div class="tab-content">
                <div class="tab-pane active" id="nav-allOrders">
                    <div class="wrap-table">
                        <table id="all_order" class="table table-borderless table-orderlist">
                            <thead>
                                <tr>
<!--                                    <th scope="col">
                            ...
                            @endif
                                    ...
                                    <td>
                                        <div class="row m-0">
                                            <button type="button" class="btn btn-light" onclick="window.location.href = '{{asset('user/user_orders_detail/'.$farm->id)}}'"><img src="{{asset('public/frontend_updated/img/ico-view.png')}}" alt="View Icon"></button>
                                           <!--<button type="button" class="btn btn-light" onclick="window.location.href = '{{asset('farmer/farmer_orders_delete/'.$farm->id)}}'"><img src="{{asset('public/frontend_updated/img/ico-trash.png')}}" alt="View Delete"></button>-->
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                 ...
                 <div class="tab-pane" id="nav-trashed">
                    <div class="wrap-table">
                        <table  id="trashed_order" class="table table-borderless table-orderlist">
                            <thead>
                                <tr>
<!--                                    <th scope="col">
                                        <div class="custom-control custom-checkbox d-flex flex-row align-items-center">
                ...
                <div class="tab-pane" id="nav-prsng">
                    <div class="wrap-table">
                        <table  id="processing_order" class="table table-borderless table-orderlist">
                            <thead>
                                <tr>
<!--                                    <th scope="col">
                                        <div class="custom-control custom-checkbox d-flex flex-row align-items-center">
                ...
                <div class="tab-pane" id="nav-hold">
                    <div class="wrap-table">
                        <table  id="hold_order" class="table table-borderless table-orderlist">
                            <thead>
                                <tr>
<!--                                    <th scope="col">
                                        <div class="custom-control custom-checkbox d-flex flex-row align-items-center">
                ...
                <div class="tab-pane" id="nav-cancelled">
                    <div class="wrap-table">
                        <table  id="cancelled_order" class="table table-borderless table-orderlist">
                            <thead>
                                <tr>
<!--                                    <th scope="col">
                                        <div class="custom-control custom-checkbox d-flex flex-row align-items-center">
...
<script>
    $(document).ready(function(){
        $('#all_order').DataTable();
        $('#trashed_order').DataTable();
        $('#hold_order').DataTable();
