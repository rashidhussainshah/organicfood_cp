                ...
                <form id="update_product" action="{{ route('update_add_product')}}" method="Post" enctype='multipart/form-data'>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1"  value="{{$product->name}}" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Description</label>
                            <textarea type="text" name="description" class="form-control" id="exampleInputPassword1" placeholder="Description Here">{{$product->description}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Price</label>
                            <input type="text" name="price" class="form-control" id="exampleInputPassword1" placeholder="$0.00" value="{{$product->price}}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Quantity</label>
                            <input type="text" name="quantityy" class="form-control" id="exampleInputPassword1" placeholder="Quantity Here" value="{{$product->quantity}}">
                        </div>
                        <div class="form-group">
                            <label>Select Category</label>
                            <select name= "category_id" class="form-control" value="{{$product->getCategory->id}}">
                        ...
                        <div class="form-group">
                            <label>Select</label>
                            <select name="unitt_id" class="form-control" value="{{$product->getUnit->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <img id="blah" src="{{ asset(isset($product->getFeaturedImage) ? $product->getFeaturedImage->path :'public/images/images.png')}}" width="250px" alt="your image"  />
                        ...
                        <div class="field" align="left">
                            ...
                            <div >
                                @if (isset($product->getProuctImages))
                                    @foreach($product->getProuctImages as $data)
